...
public class DiscExcContIEEEDEC3AQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          DiscExcContIEEEDEC3ABusinessDelegate.getDiscExcContIEEEDEC3AInstance()
              .getDiscExcContIEEEDEC3A(
                  new DiscExcContIEEEDEC3AFetchOneSummary(discExcContIEEEDEC3AId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING, "failed to load DiscExcContIEEEDEC3A using Id " + discExcContIEEEDEC3AId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(DiscExcContIEEEDEC3AQueryRestController.class.getName());
}
