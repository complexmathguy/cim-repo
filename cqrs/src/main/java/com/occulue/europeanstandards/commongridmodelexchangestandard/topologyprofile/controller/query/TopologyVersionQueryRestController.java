 ...
 * ****************************************************************************
 */
package com.occulue.europeanstandards.commongridmodelexchangestandard.topologyprofile.controller.query;
...
public class TopologyVersionQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          TopologyVersionBusinessDelegate.getTopologyVersionInstance()
              .getTopologyVersion(new TopologyVersionFetchOneSummary(topologyVersionId));
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(TopologyVersionQueryRestController.class.getName());
}
