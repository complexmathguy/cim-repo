...
public class GovHydroPID2QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          GovHydroPID2BusinessDelegate.getGovHydroPID2Instance()
              .getGovHydroPID2(new GovHydroPID2FetchOneSummary(govHydroPID2Id));
    } catch (Throwable exc) {
  ...
  public List<GovHydroPID2> loadAll() {
    ...
    try {
      ...
      govHydroPID2List =
          GovHydroPID2BusinessDelegate.getGovHydroPID2Instance().getAllGovHydroPID2();

      if (govHydroPID2List != null) LOGGER.log(Level.INFO, "successfully loaded all GovHydroPID2s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(GovHydroPID2QueryRestController.class.getName());
}
