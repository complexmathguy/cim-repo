...
public class WindGenTurbineType1IECQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          WindGenTurbineType1IECBusinessDelegate.getWindGenTurbineType1IECInstance()
              .getWindGenTurbineType1IEC(
                  new WindGenTurbineType1IECFetchOneSummary(windGenTurbineType1IECId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load WindGenTurbineType1IEC using Id " + windGenTurbineType1IECId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindGenTurbineType1IECQueryRestController.class.getName());
}
