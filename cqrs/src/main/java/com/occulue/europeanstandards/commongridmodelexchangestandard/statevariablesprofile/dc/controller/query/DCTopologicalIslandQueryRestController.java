 ...
 * ****************************************************************************
 */
package com.occulue.europeanstandards.commongridmodelexchangestandard.statevariablesprofile.dc.controller.query;
...
public class DCTopologicalIslandQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          DCTopologicalIslandBusinessDelegate.getDCTopologicalIslandInstance()
              .getDCTopologicalIsland(
                  new DCTopologicalIslandFetchOneSummary(dCTopologicalIslandId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING, "failed to load DCTopologicalIsland using Id " + dCTopologicalIslandId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(DCTopologicalIslandQueryRestController.class.getName());
}
