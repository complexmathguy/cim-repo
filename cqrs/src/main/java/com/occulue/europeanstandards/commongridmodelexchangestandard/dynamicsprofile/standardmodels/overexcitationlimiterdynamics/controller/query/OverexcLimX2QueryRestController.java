...
public class OverexcLimX2QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          OverexcLimX2BusinessDelegate.getOverexcLimX2Instance()
              .getOverexcLimX2(new OverexcLimX2FetchOneSummary(overexcLimX2Id));
    } catch (Throwable exc) {
  ...
  public List<OverexcLimX2> loadAll() {
    ...
    try {
      ...
      overexcLimX2List =
          OverexcLimX2BusinessDelegate.getOverexcLimX2Instance().getAllOverexcLimX2();

      if (overexcLimX2List != null) LOGGER.log(Level.INFO, "successfully loaded all OverexcLimX2s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(OverexcLimX2QueryRestController.class.getName());
}
