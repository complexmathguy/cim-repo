...
public class StaticVarCompensatorQueryRestController extends BaseSpringRestController {
  ...
  public StaticVarCompensator load(@RequestParam(required = true) UUID staticVarCompensatorId) {
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING, "failed to load StaticVarCompensator using Id " + staticVarCompensatorId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(StaticVarCompensatorQueryRestController.class.getName());
}
