...
public class WindTurbineType1or2DynamicsQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public WindTurbineType1or2Dynamics load(
    ...
    try {
      entity =
          WindTurbineType1or2DynamicsBusinessDelegate.getWindTurbineType1or2DynamicsInstance()
              .getWindTurbineType1or2Dynamics(
                  new WindTurbineType1or2DynamicsFetchOneSummary(windTurbineType1or2DynamicsId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load WindTurbineType1or2Dynamics using Id " + windTurbineType1or2DynamicsId);
      return null;
    }
  ...
  public List<WindTurbineType1or2Dynamics> loadAll() {
    ...
    try {
      ...
      windTurbineType1or2DynamicsList =
          WindTurbineType1or2DynamicsBusinessDelegate.getWindTurbineType1or2DynamicsInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindTurbineType1or2DynamicsQueryRestController.class.getName());
}
