...
public class PFVArControllerType2UserDefinedCommandRestController extends BaseSpringRestController {
  ...
  /**
   * Handles create a PFVArControllerType2UserDefined. if not key provided, calls create, otherwise
   * calls save
   *
  ...
  public CompletableFuture<UUID> create(
      @RequestBody(required = true) CreatePFVArControllerType2UserDefinedCommand command) {
    ...
    try {
      ...
      completableFuture =
          PFVArControllerType2UserDefinedBusinessDelegate
              ...
              .createPFVArControllerType2UserDefined(command);
    } catch (Throwable exc) {
  ...
  /**
   * Handles updating a PFVArControllerType2UserDefined. if no key provided, calls create, otherwise
   * calls save
   *
   * @param PFVArControllerType2UserDefined pFVArControllerType2UserDefined
  ...
  public CompletableFuture<Void> update(
      @RequestBody(required = true) UpdatePFVArControllerType2UserDefinedCommand command) {
    ...
    try {
      ...
      completableFuture =
          PFVArControllerType2UserDefinedBusinessDelegate
              .getPFVArControllerType2UserDefinedInstance()
              .updatePFVArControllerType2UserDefined(command);
      ;
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "PFVArControllerType2UserDefinedController:update() - successfully update PFVArControllerType2UserDefined - "
              + exc.getMessage());
    }
  ...
  public CompletableFuture<Void> delete(
    ...
    CompletableFuture<Void> completableFuture = null;
    DeletePFVArControllerType2UserDefinedCommand command =
        new DeletePFVArControllerType2UserDefinedCommand(pFVArControllerType2UserDefinedId);

    try {
      PFVArControllerType2UserDefinedBusinessDelegate delegate =
          PFVArControllerType2UserDefinedBusinessDelegate
              .getPFVArControllerType2UserDefinedInstance();
      ...
      LOGGER.log(
          Level.WARNING,
          "Successfully deleted PFVArControllerType2UserDefined with key "
  ...
  public void assignProprietary(
      @RequestBody AssignProprietaryToPFVArControllerType2UserDefinedCommand command) {
    try {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PFVArControllerType2UserDefinedCommandRestController.class.getName());
}
