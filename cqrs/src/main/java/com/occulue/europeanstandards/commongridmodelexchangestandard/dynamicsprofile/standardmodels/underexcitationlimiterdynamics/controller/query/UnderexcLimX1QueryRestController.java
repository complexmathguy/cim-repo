...
public class UnderexcLimX1QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          UnderexcLimX1BusinessDelegate.getUnderexcLimX1Instance()
              .getUnderexcLimX1(new UnderexcLimX1FetchOneSummary(underexcLimX1Id));
    } catch (Throwable exc) {
  ...
  public List<UnderexcLimX1> loadAll() {
    ...
    try {
      ...
      underexcLimX1List =
          UnderexcLimX1BusinessDelegate.getUnderexcLimX1Instance().getAllUnderexcLimX1();
  ...
  private static final Logger LOGGER =
      Logger.getLogger(UnderexcLimX1QueryRestController.class.getName());
}
