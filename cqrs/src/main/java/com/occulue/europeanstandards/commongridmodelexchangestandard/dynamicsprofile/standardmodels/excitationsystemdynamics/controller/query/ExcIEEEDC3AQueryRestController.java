...
public class ExcIEEEDC3AQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEDC3ABusinessDelegate.getExcIEEEDC3AInstance()
              .getExcIEEEDC3A(new ExcIEEEDC3AFetchOneSummary(excIEEEDC3AId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEDC3A> loadAll() {
    ...
    try {
      ...
      if (excIEEEDC3AList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEDC3As");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEDC3AQueryRestController.class.getName());
}
