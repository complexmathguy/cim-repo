...
public class PhaseTapChangerSymmetricalQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public PhaseTapChangerSymmetrical load(
    ...
    try {
      entity =
          PhaseTapChangerSymmetricalBusinessDelegate.getPhaseTapChangerSymmetricalInstance()
              .getPhaseTapChangerSymmetrical(
                  new PhaseTapChangerSymmetricalFetchOneSummary(phaseTapChangerSymmetricalId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load PhaseTapChangerSymmetrical using Id " + phaseTapChangerSymmetricalId);
      return null;
    }
  ...
  public List<PhaseTapChangerSymmetrical> loadAll() {
    ...
    try {
      ...
      phaseTapChangerSymmetricalList =
          PhaseTapChangerSymmetricalBusinessDelegate.getPhaseTapChangerSymmetricalInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PhaseTapChangerSymmetricalQueryRestController.class.getName());
}
