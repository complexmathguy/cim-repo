 ...
 * ****************************************************************************
 */
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentboundaryprofile.controller.query;
...
public class EquipmentBoundaryVersionQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public EquipmentBoundaryVersion load(
    ...
    try {
      entity =
          EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance()
              .getEquipmentBoundaryVersion(
                  new EquipmentBoundaryVersionFetchOneSummary(equipmentBoundaryVersionId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load EquipmentBoundaryVersion using Id " + equipmentBoundaryVersionId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(EquipmentBoundaryVersionQueryRestController.class.getName());
}
