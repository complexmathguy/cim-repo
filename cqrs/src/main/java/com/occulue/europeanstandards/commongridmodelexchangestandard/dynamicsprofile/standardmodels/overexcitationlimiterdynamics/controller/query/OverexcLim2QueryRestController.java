...
public class OverexcLim2QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          OverexcLim2BusinessDelegate.getOverexcLim2Instance()
              .getOverexcLim2(new OverexcLim2FetchOneSummary(overexcLim2Id));
    } catch (Throwable exc) {
  ...
  public List<OverexcLim2> loadAll() {
    ...
    try {
      ...
      if (overexcLim2List != null) LOGGER.log(Level.INFO, "successfully loaded all OverexcLim2s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(OverexcLim2QueryRestController.class.getName());
}
