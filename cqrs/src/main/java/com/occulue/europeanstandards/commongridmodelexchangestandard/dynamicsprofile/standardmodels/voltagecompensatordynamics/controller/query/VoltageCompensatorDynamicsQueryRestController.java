 ...
 * ****************************************************************************
 */
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.voltagecompensatordynamics.controller.query;
...
public class VoltageCompensatorDynamicsQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public VoltageCompensatorDynamics load(
    ...
    try {
      entity =
          VoltageCompensatorDynamicsBusinessDelegate.getVoltageCompensatorDynamicsInstance()
              .getVoltageCompensatorDynamics(
                  new VoltageCompensatorDynamicsFetchOneSummary(voltageCompensatorDynamicsId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load VoltageCompensatorDynamics using Id " + voltageCompensatorDynamicsId);
      return null;
    }
  ...
  public List<VoltageCompensatorDynamics> loadAll() {
    ...
    try {
      ...
      voltageCompensatorDynamicsList =
          VoltageCompensatorDynamicsBusinessDelegate.getVoltageCompensatorDynamicsInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(VoltageCompensatorDynamicsQueryRestController.class.getName());
}
