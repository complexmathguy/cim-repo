...
public class UnderexcLimX2QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          UnderexcLimX2BusinessDelegate.getUnderexcLimX2Instance()
              .getUnderexcLimX2(new UnderexcLimX2FetchOneSummary(underexcLimX2Id));
    } catch (Throwable exc) {
  ...
  public List<UnderexcLimX2> loadAll() {
    ...
    try {
      ...
      underexcLimX2List =
          UnderexcLimX2BusinessDelegate.getUnderexcLimX2Instance().getAllUnderexcLimX2();
  ...
  private static final Logger LOGGER =
      Logger.getLogger(UnderexcLimX2QueryRestController.class.getName());
}
