...
public class PssELIN2QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          PssELIN2BusinessDelegate.getPssELIN2Instance()
              .getPssELIN2(new PssELIN2FetchOneSummary(pssELIN2Id));
    } catch (Throwable exc) {
  ...
  public List<PssELIN2> loadAll() {
    ...
    try {
      ...
      if (pssELIN2List != null) LOGGER.log(Level.INFO, "successfully loaded all PssELIN2s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PssELIN2QueryRestController.class.getName());
}
