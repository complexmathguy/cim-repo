...
public class ExcELIN2QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcELIN2BusinessDelegate.getExcELIN2Instance()
              .getExcELIN2(new ExcELIN2FetchOneSummary(excELIN2Id));
    } catch (Throwable exc) {
  ...
  public List<ExcELIN2> loadAll() {
    ...
    try {
      ...
      if (excELIN2List != null) LOGGER.log(Level.INFO, "successfully loaded all ExcELIN2s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcELIN2QueryRestController.class.getName());
}
