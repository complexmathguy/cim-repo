...
public class ExcIEEEAC1AQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEAC1ABusinessDelegate.getExcIEEEAC1AInstance()
              .getExcIEEEAC1A(new ExcIEEEAC1AFetchOneSummary(excIEEEAC1AId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEAC1A> loadAll() {
    ...
    try {
      ...
      if (excIEEEAC1AList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEAC1As");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEAC1AQueryRestController.class.getName());
}
