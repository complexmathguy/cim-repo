...
public class WindType3or4UserDefinedQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public WindType3or4UserDefined load(
    ...
    try {
      entity =
          WindType3or4UserDefinedBusinessDelegate.getWindType3or4UserDefinedInstance()
              .getWindType3or4UserDefined(
                  new WindType3or4UserDefinedFetchOneSummary(windType3or4UserDefinedId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load WindType3or4UserDefined using Id " + windType3or4UserDefinedId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindType3or4UserDefinedQueryRestController.class.getName());
}
