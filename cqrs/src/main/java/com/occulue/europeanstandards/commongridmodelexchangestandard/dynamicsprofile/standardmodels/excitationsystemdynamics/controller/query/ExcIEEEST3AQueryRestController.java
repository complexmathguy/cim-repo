...
public class ExcIEEEST3AQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEST3ABusinessDelegate.getExcIEEEST3AInstance()
              .getExcIEEEST3A(new ExcIEEEST3AFetchOneSummary(excIEEEST3AId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEST3A> loadAll() {
    ...
    try {
      ...
      if (excIEEEST3AList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEST3As");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEST3AQueryRestController.class.getName());
}
