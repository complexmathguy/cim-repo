...
public class MonthDayIntervalQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          MonthDayIntervalBusinessDelegate.getMonthDayIntervalInstance()
              .getMonthDayInterval(new MonthDayIntervalFetchOneSummary(monthDayIntervalId));
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(MonthDayIntervalQueryRestController.class.getName());
}
