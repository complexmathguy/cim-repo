...
public class PssPTIST3QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          PssPTIST3BusinessDelegate.getPssPTIST3Instance()
              .getPssPTIST3(new PssPTIST3FetchOneSummary(pssPTIST3Id));
    } catch (Throwable exc) {
  ...
  public List<PssPTIST3> loadAll() {
    ...
    try {
      ...
      if (pssPTIST3List != null) LOGGER.log(Level.INFO, "successfully loaded all PssPTIST3s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PssPTIST3QueryRestController.class.getName());
}
