...
public class UnderexcLim2SimplifiedQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          UnderexcLim2SimplifiedBusinessDelegate.getUnderexcLim2SimplifiedInstance()
              .getUnderexcLim2Simplified(
                  new UnderexcLim2SimplifiedFetchOneSummary(underexcLim2SimplifiedId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load UnderexcLim2Simplified using Id " + underexcLim2SimplifiedId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(UnderexcLim2SimplifiedQueryRestController.class.getName());
}
