...
public class GovHydro4QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          GovHydro4BusinessDelegate.getGovHydro4Instance()
              .getGovHydro4(new GovHydro4FetchOneSummary(govHydro4Id));
    } catch (Throwable exc) {
  ...
  public List<GovHydro4> loadAll() {
    ...
    try {
      ...
      if (govHydro4List != null) LOGGER.log(Level.INFO, "successfully loaded all GovHydro4s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(GovHydro4QueryRestController.class.getName());
}
