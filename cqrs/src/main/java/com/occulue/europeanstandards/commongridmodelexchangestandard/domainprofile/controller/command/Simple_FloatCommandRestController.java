...
public class Simple_FloatCommandRestController extends BaseSpringRestController {
  ...
  public CompletableFuture<UUID> create(
      @RequestBody(required = true) CreateSimple_FloatCommand command) {
    CompletableFuture<UUID> completableFuture = null;
    try {

      completableFuture =
          Simple_FloatBusinessDelegate.getSimple_FloatInstance().createSimple_Float(command);
    } catch (Throwable exc) {
  ...
  public CompletableFuture<Void> update(
      @RequestBody(required = true) UpdateSimple_FloatCommand command) {
    ...
    try {
      ...
      // -----------------------------------------------
      completableFuture =
          Simple_FloatBusinessDelegate.getSimple_FloatInstance().updateSimple_Float(command);
      ;
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "Simple_FloatController:update() - successfully update Simple_Float - "
              + exc.getMessage());
    }
  ...
  public CompletableFuture<Void> delete(@RequestParam(required = true) UUID simple_FloatId) {
    ...
    try {
      Simple_FloatBusinessDelegate delegate =
          Simple_FloatBusinessDelegate.getSimple_FloatInstance();

      completableFuture = delegate.delete(command);
      LOGGER.log(
          Level.WARNING,
          "Successfully deleted Simple_Float with key " + command.getSimple_FloatId());
    } catch (Throwable exc) {
  ...
  public void unAssignValue(
      @RequestBody(required = true) UnAssignValueFromSimple_FloatCommand command) {
    try {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(Simple_FloatCommandRestController.class.getName());
}
