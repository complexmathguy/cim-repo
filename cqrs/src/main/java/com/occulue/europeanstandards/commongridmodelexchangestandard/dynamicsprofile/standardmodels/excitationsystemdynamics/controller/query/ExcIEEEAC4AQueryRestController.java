...
public class ExcIEEEAC4AQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEAC4ABusinessDelegate.getExcIEEEAC4AInstance()
              .getExcIEEEAC4A(new ExcIEEEAC4AFetchOneSummary(excIEEEAC4AId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEAC4A> loadAll() {
    ...
    try {
      ...
      if (excIEEEAC4AList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEAC4As");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEAC4AQueryRestController.class.getName());
}
