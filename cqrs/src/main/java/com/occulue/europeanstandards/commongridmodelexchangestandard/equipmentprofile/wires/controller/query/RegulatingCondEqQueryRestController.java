...
public class RegulatingCondEqQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          RegulatingCondEqBusinessDelegate.getRegulatingCondEqInstance()
              .getRegulatingCondEq(new RegulatingCondEqFetchOneSummary(regulatingCondEqId));
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(RegulatingCondEqQueryRestController.class.getName());
}
