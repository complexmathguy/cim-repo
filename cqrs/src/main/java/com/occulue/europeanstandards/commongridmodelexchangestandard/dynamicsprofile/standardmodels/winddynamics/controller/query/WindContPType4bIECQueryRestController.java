...
public class WindContPType4bIECQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          WindContPType4bIECBusinessDelegate.getWindContPType4bIECInstance()
              .getWindContPType4bIEC(new WindContPType4bIECFetchOneSummary(windContPType4bIECId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING, "failed to load WindContPType4bIEC using Id " + windContPType4bIECId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindContPType4bIECQueryRestController.class.getName());
}
