...
public class SeriesCompensatorQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          SeriesCompensatorBusinessDelegate.getSeriesCompensatorInstance()
              .getSeriesCompensator(new SeriesCompensatorFetchOneSummary(seriesCompensatorId));
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(SeriesCompensatorQueryRestController.class.getName());
}
