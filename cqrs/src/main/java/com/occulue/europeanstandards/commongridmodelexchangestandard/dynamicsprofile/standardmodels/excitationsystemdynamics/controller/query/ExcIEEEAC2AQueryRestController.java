...
public class ExcIEEEAC2AQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEAC2ABusinessDelegate.getExcIEEEAC2AInstance()
              .getExcIEEEAC2A(new ExcIEEEAC2AFetchOneSummary(excIEEEAC2AId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEAC2A> loadAll() {
    ...
    try {
      ...
      if (excIEEEAC2AList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEAC2As");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEAC2AQueryRestController.class.getName());
}
