...
public class DiscExcContIEEEDEC1AQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          DiscExcContIEEEDEC1ABusinessDelegate.getDiscExcContIEEEDEC1AInstance()
              .getDiscExcContIEEEDEC1A(
                  new DiscExcContIEEEDEC1AFetchOneSummary(discExcContIEEEDEC1AId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING, "failed to load DiscExcContIEEEDEC1A using Id " + discExcContIEEEDEC1AId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(DiscExcContIEEEDEC1AQueryRestController.class.getName());
}
