 ...
 * ****************************************************************************
 */
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.turbineloadcontrollerdynamics.controller.query;
...
public class TurbineLoadControllerDynamicsQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public TurbineLoadControllerDynamics load(
    ...
    try {
      entity =
          TurbineLoadControllerDynamicsBusinessDelegate.getTurbineLoadControllerDynamicsInstance()
              .getTurbineLoadControllerDynamics(
                  new TurbineLoadControllerDynamicsFetchOneSummary(
                      turbineLoadControllerDynamicsId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load TurbineLoadControllerDynamics using Id "
              + turbineLoadControllerDynamicsId);
      return null;
    }
  ...
  public List<TurbineLoadControllerDynamics> loadAll() {
    ...
    try {
      ...
      turbineLoadControllerDynamicsList =
          TurbineLoadControllerDynamicsBusinessDelegate.getTurbineLoadControllerDynamicsInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(TurbineLoadControllerDynamicsQueryRestController.class.getName());
}
