...
public class OverexcitationLimiterDynamicsQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public OverexcitationLimiterDynamics load(
    ...
    try {
      entity =
          OverexcitationLimiterDynamicsBusinessDelegate.getOverexcitationLimiterDynamicsInstance()
              .getOverexcitationLimiterDynamics(
                  new OverexcitationLimiterDynamicsFetchOneSummary(
                      overexcitationLimiterDynamicsId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load OverexcitationLimiterDynamics using Id "
              + overexcitationLimiterDynamicsId);
      return null;
    }
  ...
  public List<OverexcitationLimiterDynamics> loadAll() {
    ...
    try {
      ...
      overexcitationLimiterDynamicsList =
          OverexcitationLimiterDynamicsBusinessDelegate.getOverexcitationLimiterDynamicsInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(OverexcitationLimiterDynamicsQueryRestController.class.getName());
}
