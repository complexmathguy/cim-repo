...
public class ConductingEquipmentQueryRestController extends BaseSpringRestController {
  ...
  public ConductingEquipment load(@RequestParam(required = true) UUID conductingEquipmentId) {
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING, "failed to load ConductingEquipment using Id " + conductingEquipmentId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ConductingEquipmentQueryRestController.class.getName());
}
