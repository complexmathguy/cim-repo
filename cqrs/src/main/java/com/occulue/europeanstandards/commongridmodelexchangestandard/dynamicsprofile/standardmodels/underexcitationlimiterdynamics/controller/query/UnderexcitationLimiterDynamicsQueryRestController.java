 ...
 * ****************************************************************************
 */
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.underexcitationlimiterdynamics.controller.query;
...
public class UnderexcitationLimiterDynamicsQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public UnderexcitationLimiterDynamics load(
      ...
      entity =
          UnderexcitationLimiterDynamicsBusinessDelegate.getUnderexcitationLimiterDynamicsInstance()
              .getUnderexcitationLimiterDynamics(
                  new UnderexcitationLimiterDynamicsFetchOneSummary(
                      underexcitationLimiterDynamicsId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load UnderexcitationLimiterDynamics using Id "
              + underexcitationLimiterDynamicsId);
      return null;
    }
  ...
  public List<UnderexcitationLimiterDynamics> loadAll() {
    ...
    try {
      ...
      underexcitationLimiterDynamicsList =
          UnderexcitationLimiterDynamicsBusinessDelegate.getUnderexcitationLimiterDynamicsInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(UnderexcitationLimiterDynamicsQueryRestController.class.getName());
}
