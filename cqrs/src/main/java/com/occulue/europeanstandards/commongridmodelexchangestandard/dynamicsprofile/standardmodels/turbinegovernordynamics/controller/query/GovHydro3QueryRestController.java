...
public class GovHydro3QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          GovHydro3BusinessDelegate.getGovHydro3Instance()
              .getGovHydro3(new GovHydro3FetchOneSummary(govHydro3Id));
    } catch (Throwable exc) {
  ...
  public List<GovHydro3> loadAll() {
    ...
    try {
      ...
      if (govHydro3List != null) LOGGER.log(Level.INFO, "successfully loaded all GovHydro3s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(GovHydro3QueryRestController.class.getName());
}
