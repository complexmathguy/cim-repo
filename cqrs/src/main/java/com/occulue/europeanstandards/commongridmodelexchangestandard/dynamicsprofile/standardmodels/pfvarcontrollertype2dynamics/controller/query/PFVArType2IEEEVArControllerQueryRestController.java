...
public class PFVArType2IEEEVArControllerQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public PFVArType2IEEEVArController load(
    ...
    try {
      entity =
          PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance()
              .getPFVArType2IEEEVArController(
                  new PFVArType2IEEEVArControllerFetchOneSummary(pFVArType2IEEEVArControllerId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load PFVArType2IEEEVArController using Id " + pFVArType2IEEEVArControllerId);
      return null;
    }
  ...
  public List<PFVArType2IEEEVArController> loadAll() {
    ...
    try {
      ...
      pFVArType2IEEEVArControllerList =
          PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PFVArType2IEEEVArControllerQueryRestController.class.getName());
}
