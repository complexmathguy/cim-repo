...
public class WindGenTurbineType3aIECQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public WindGenTurbineType3aIEC load(
    ...
    try {
      entity =
          WindGenTurbineType3aIECBusinessDelegate.getWindGenTurbineType3aIECInstance()
              .getWindGenTurbineType3aIEC(
                  new WindGenTurbineType3aIECFetchOneSummary(windGenTurbineType3aIECId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load WindGenTurbineType3aIEC using Id " + windGenTurbineType3aIECId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindGenTurbineType3aIECQueryRestController.class.getName());
}
