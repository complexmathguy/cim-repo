...
public class ExcIEEEAC3AQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEAC3ABusinessDelegate.getExcIEEEAC3AInstance()
              .getExcIEEEAC3A(new ExcIEEEAC3AFetchOneSummary(excIEEEAC3AId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEAC3A> loadAll() {
    ...
    try {
      ...
      if (excIEEEAC3AList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEAC3As");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEAC3AQueryRestController.class.getName());
}
