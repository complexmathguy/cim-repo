...
public class ExcitationSystemUserDefinedCommandRestController extends BaseSpringRestController {
  ...
  /**
   * Handles create a ExcitationSystemUserDefined. if not key provided, calls create, otherwise
   * calls save
   *
  ...
  public CompletableFuture<UUID> create(
      @RequestBody(required = true) CreateExcitationSystemUserDefinedCommand command) {
    CompletableFuture<UUID> completableFuture = null;
    try {

      completableFuture =
          ExcitationSystemUserDefinedBusinessDelegate.getExcitationSystemUserDefinedInstance()
              .createExcitationSystemUserDefined(command);
    } catch (Throwable exc) {
  ...
  /**
   * Handles updating a ExcitationSystemUserDefined. if no key provided, calls create, otherwise
   * calls save
   *
   * @param ExcitationSystemUserDefined excitationSystemUserDefined
  ...
  public CompletableFuture<Void> update(
      @RequestBody(required = true) UpdateExcitationSystemUserDefinedCommand command) {
    ...
    try {
      ...
      completableFuture =
          ExcitationSystemUserDefinedBusinessDelegate.getExcitationSystemUserDefinedInstance()
              .updateExcitationSystemUserDefined(command);
      ;
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "ExcitationSystemUserDefinedController:update() - successfully update ExcitationSystemUserDefined - "
              + exc.getMessage());
    }
  ...
  public CompletableFuture<Void> delete(
    ...
    CompletableFuture<Void> completableFuture = null;
    DeleteExcitationSystemUserDefinedCommand command =
        new DeleteExcitationSystemUserDefinedCommand(excitationSystemUserDefinedId);

    try {
      ExcitationSystemUserDefinedBusinessDelegate delegate =
          ExcitationSystemUserDefinedBusinessDelegate.getExcitationSystemUserDefinedInstance();

      completableFuture = delegate.delete(command);
      LOGGER.log(
          Level.WARNING,
          "Successfully deleted ExcitationSystemUserDefined with key "
  ...
  public void assignProprietary(
      @RequestBody AssignProprietaryToExcitationSystemUserDefinedCommand command) {
    try {
      ExcitationSystemUserDefinedBusinessDelegate.getExcitationSystemUserDefinedInstance()
  ...
  public void unAssignProprietary(
      @RequestBody(required = true)
          UnAssignProprietaryFromExcitationSystemUserDefinedCommand command) {
    try {
      ExcitationSystemUserDefinedBusinessDelegate.getExcitationSystemUserDefinedInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcitationSystemUserDefinedCommandRestController.class.getName());
}
