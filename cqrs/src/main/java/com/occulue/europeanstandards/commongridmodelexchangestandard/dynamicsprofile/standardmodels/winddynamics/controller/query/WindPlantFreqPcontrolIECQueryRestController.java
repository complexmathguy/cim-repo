...
public class WindPlantFreqPcontrolIECQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public WindPlantFreqPcontrolIEC load(
    ...
    try {
      entity =
          WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance()
              .getWindPlantFreqPcontrolIEC(
                  new WindPlantFreqPcontrolIECFetchOneSummary(windPlantFreqPcontrolIECId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load WindPlantFreqPcontrolIEC using Id " + windPlantFreqPcontrolIECId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindPlantFreqPcontrolIECQueryRestController.class.getName());
}
