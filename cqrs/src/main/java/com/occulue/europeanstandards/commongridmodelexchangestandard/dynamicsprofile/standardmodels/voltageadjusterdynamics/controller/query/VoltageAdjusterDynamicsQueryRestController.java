 ...
 * ****************************************************************************
 */
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.voltageadjusterdynamics.controller.query;
...
public class VoltageAdjusterDynamicsQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public VoltageAdjusterDynamics load(
    ...
    try {
      entity =
          VoltageAdjusterDynamicsBusinessDelegate.getVoltageAdjusterDynamicsInstance()
              .getVoltageAdjusterDynamics(
                  new VoltageAdjusterDynamicsFetchOneSummary(voltageAdjusterDynamicsId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load VoltageAdjusterDynamics using Id " + voltageAdjusterDynamicsId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(VoltageAdjusterDynamicsQueryRestController.class.getName());
}
