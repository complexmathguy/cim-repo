...
public class ConformLoadGroupQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ConformLoadGroupBusinessDelegate.getConformLoadGroupInstance()
              .getConformLoadGroup(new ConformLoadGroupFetchOneSummary(conformLoadGroupId));
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ConformLoadGroupQueryRestController.class.getName());
}
