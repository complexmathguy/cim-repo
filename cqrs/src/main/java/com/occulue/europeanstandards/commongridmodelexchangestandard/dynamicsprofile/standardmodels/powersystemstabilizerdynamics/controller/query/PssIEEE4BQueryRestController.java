...
public class PssIEEE4BQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          PssIEEE4BBusinessDelegate.getPssIEEE4BInstance()
              .getPssIEEE4B(new PssIEEE4BFetchOneSummary(pssIEEE4BId));
    } catch (Throwable exc) {
  ...
  public List<PssIEEE4B> loadAll() {
    ...
    try {
      ...
      if (pssIEEE4BList != null) LOGGER.log(Level.INFO, "successfully loaded all PssIEEE4Bs");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PssIEEE4BQueryRestController.class.getName());
}
