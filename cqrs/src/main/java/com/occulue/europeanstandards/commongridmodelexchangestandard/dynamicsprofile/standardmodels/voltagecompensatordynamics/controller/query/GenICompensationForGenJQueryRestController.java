...
public class GenICompensationForGenJQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public GenICompensationForGenJ load(
    ...
    try {
      entity =
          GenICompensationForGenJBusinessDelegate.getGenICompensationForGenJInstance()
              .getGenICompensationForGenJ(
                  new GenICompensationForGenJFetchOneSummary(genICompensationForGenJId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load GenICompensationForGenJ using Id " + genICompensationForGenJId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(GenICompensationForGenJQueryRestController.class.getName());
}
