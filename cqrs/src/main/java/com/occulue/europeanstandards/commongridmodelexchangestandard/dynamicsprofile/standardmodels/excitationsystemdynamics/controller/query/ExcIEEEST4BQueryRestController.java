...
public class ExcIEEEST4BQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEST4BBusinessDelegate.getExcIEEEST4BInstance()
              .getExcIEEEST4B(new ExcIEEEST4BFetchOneSummary(excIEEEST4BId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEST4B> loadAll() {
    ...
    try {
      ...
      if (excIEEEST4BList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEST4Bs");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEST4BQueryRestController.class.getName());
}
