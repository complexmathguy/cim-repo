 ...
 * ****************************************************************************
 */
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.topology.controller.query;
...
public class BusNameMarkerQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          BusNameMarkerBusinessDelegate.getBusNameMarkerInstance()
              .getBusNameMarker(new BusNameMarkerFetchOneSummary(busNameMarkerId));
    } catch (Throwable exc) {
  ...
  public List<BusNameMarker> loadAll() {
    ...
    try {
      ...
      busNameMarkerList =
          BusNameMarkerBusinessDelegate.getBusNameMarkerInstance().getAllBusNameMarker();
  ...
  private static final Logger LOGGER =
      Logger.getLogger(BusNameMarkerQueryRestController.class.getName());
}
