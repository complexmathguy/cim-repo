...
public class TapChangerControlQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          TapChangerControlBusinessDelegate.getTapChangerControlInstance()
              .getTapChangerControl(new TapChangerControlFetchOneSummary(tapChangerControlId));
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(TapChangerControlQueryRestController.class.getName());
}
