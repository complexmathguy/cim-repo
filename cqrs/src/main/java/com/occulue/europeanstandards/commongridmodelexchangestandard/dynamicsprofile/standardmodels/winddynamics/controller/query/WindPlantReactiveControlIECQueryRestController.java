...
public class WindPlantReactiveControlIECQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public WindPlantReactiveControlIEC load(
    ...
    try {
      entity =
          WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance()
              .getWindPlantReactiveControlIEC(
                  new WindPlantReactiveControlIECFetchOneSummary(windPlantReactiveControlIECId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load WindPlantReactiveControlIEC using Id " + windPlantReactiveControlIECId);
      return null;
    }
  ...
  public List<WindPlantReactiveControlIEC> loadAll() {
    ...
    try {
      ...
      windPlantReactiveControlIECList =
          WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindPlantReactiveControlIECQueryRestController.class.getName());
}
