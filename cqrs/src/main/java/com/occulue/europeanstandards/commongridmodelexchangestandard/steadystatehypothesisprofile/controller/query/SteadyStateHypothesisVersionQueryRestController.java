 ...
 * ****************************************************************************
 */
package com.occulue.europeanstandards.commongridmodelexchangestandard.steadystatehypothesisprofile.controller.query;
...
public class SteadyStateHypothesisVersionQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public SteadyStateHypothesisVersion load(
    ...
    try {
      entity =
          SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance()
              .getSteadyStateHypothesisVersion(
                  new SteadyStateHypothesisVersionFetchOneSummary(steadyStateHypothesisVersionId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load SteadyStateHypothesisVersion using Id " + steadyStateHypothesisVersionId);
      return null;
    }
  ...
  public List<SteadyStateHypothesisVersion> loadAll() {
    ...
    try {
      ...
      steadyStateHypothesisVersionList =
          SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(SteadyStateHypothesisVersionQueryRestController.class.getName());
}
