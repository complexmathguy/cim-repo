...
public class ReactiveCapabilityCurveQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public ReactiveCapabilityCurve load(
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING,
          "failed to load ReactiveCapabilityCurve using Id " + reactiveCapabilityCurveId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ReactiveCapabilityCurveQueryRestController.class.getName());
}
