...
public class DiscontinuousExcitationControlUserDefinedQueryRestController
   ...
   */
  @GetMapping("/load")
  public DiscontinuousExcitationControlUserDefined load(
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING,
          "failed to load DiscontinuousExcitationControlUserDefined using Id "
              + discontinuousExcitationControlUserDefinedId);
      return null;
    }
  ...
  public List<DiscontinuousExcitationControlUserDefined> loadAll() {
    List<DiscontinuousExcitationControlUserDefined> discontinuousExcitationControlUserDefinedList =
        null;

    try {
      // load the DiscontinuousExcitationControlUserDefined
      discontinuousExcitationControlUserDefinedList =
          DiscontinuousExcitationControlUserDefinedBusinessDelegate
              .getDiscontinuousExcitationControlUserDefinedInstance()
      ...
      if (discontinuousExcitationControlUserDefinedList != null)
        LOGGER.log(
            Level.INFO, "successfully loaded all DiscontinuousExcitationControlUserDefineds");
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING, "failed to load all DiscontinuousExcitationControlUserDefineds ", exc);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(
          DiscontinuousExcitationControlUserDefinedQueryRestController.class.getName());
}
