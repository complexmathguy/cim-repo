...
public class WindContPType4aIECQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          WindContPType4aIECBusinessDelegate.getWindContPType4aIECInstance()
              .getWindContPType4aIEC(new WindContPType4aIECFetchOneSummary(windContPType4aIECId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING, "failed to load WindContPType4aIEC using Id " + windContPType4aIECId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindContPType4aIECQueryRestController.class.getName());
}
