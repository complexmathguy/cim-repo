...
public class SynchronousMachineSimplifiedQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public SynchronousMachineSimplified load(
    ...
    try {
      entity =
          SynchronousMachineSimplifiedBusinessDelegate.getSynchronousMachineSimplifiedInstance()
              .getSynchronousMachineSimplified(
                  new SynchronousMachineSimplifiedFetchOneSummary(synchronousMachineSimplifiedId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load SynchronousMachineSimplified using Id " + synchronousMachineSimplifiedId);
      return null;
    }
  ...
  public List<SynchronousMachineSimplified> loadAll() {
    ...
    try {
      ...
      synchronousMachineSimplifiedList =
          SynchronousMachineSimplifiedBusinessDelegate.getSynchronousMachineSimplifiedInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(SynchronousMachineSimplifiedQueryRestController.class.getName());
}
