...
public class PFVArType1IEEEPFControllerQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public PFVArType1IEEEPFController load(
    ...
    try {
      entity =
          PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance()
              .getPFVArType1IEEEPFController(
                  new PFVArType1IEEEPFControllerFetchOneSummary(pFVArType1IEEEPFControllerId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load PFVArType1IEEEPFController using Id " + pFVArType1IEEEPFControllerId);
      return null;
    }
  ...
  public List<PFVArType1IEEEPFController> loadAll() {
    ...
    try {
      ...
      pFVArType1IEEEPFControllerList =
          PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PFVArType1IEEEPFControllerQueryRestController.class.getName());
}
