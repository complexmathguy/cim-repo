...
public class SynchronousMachineDynamicsQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public SynchronousMachineDynamics load(
    ...
    try {
      entity =
          SynchronousMachineDynamicsBusinessDelegate.getSynchronousMachineDynamicsInstance()
              .getSynchronousMachineDynamics(
                  new SynchronousMachineDynamicsFetchOneSummary(synchronousMachineDynamicsId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load SynchronousMachineDynamics using Id " + synchronousMachineDynamicsId);
      return null;
    }
  ...
  public List<SynchronousMachineDynamics> loadAll() {
    ...
    try {
      ...
      synchronousMachineDynamicsList =
          SynchronousMachineDynamicsBusinessDelegate.getSynchronousMachineDynamicsInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(SynchronousMachineDynamicsQueryRestController.class.getName());
}
