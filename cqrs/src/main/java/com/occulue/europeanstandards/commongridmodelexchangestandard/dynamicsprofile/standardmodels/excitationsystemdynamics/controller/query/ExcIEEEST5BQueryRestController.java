...
public class ExcIEEEST5BQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEST5BBusinessDelegate.getExcIEEEST5BInstance()
              .getExcIEEEST5B(new ExcIEEEST5BFetchOneSummary(excIEEEST5BId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEST5B> loadAll() {
    ...
    try {
      ...
      if (excIEEEST5BList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEST5Bs");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEST5BQueryRestController.class.getName());
}
