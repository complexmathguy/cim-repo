...
public class ExcIEEEAC6AQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEAC6ABusinessDelegate.getExcIEEEAC6AInstance()
              .getExcIEEEAC6A(new ExcIEEEAC6AFetchOneSummary(excIEEEAC6AId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEAC6A> loadAll() {
    ...
    try {
      ...
      if (excIEEEAC6AList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEAC6As");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEAC6AQueryRestController.class.getName());
}
