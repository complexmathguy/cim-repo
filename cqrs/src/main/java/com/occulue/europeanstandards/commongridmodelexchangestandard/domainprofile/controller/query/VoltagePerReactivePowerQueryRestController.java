...
public class VoltagePerReactivePowerQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public VoltagePerReactivePower load(
    ...
    try {
      entity =
          VoltagePerReactivePowerBusinessDelegate.getVoltagePerReactivePowerInstance()
              .getVoltagePerReactivePower(
                  new VoltagePerReactivePowerFetchOneSummary(voltagePerReactivePowerId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load VoltagePerReactivePower using Id " + voltagePerReactivePowerId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(VoltagePerReactivePowerQueryRestController.class.getName());
}
