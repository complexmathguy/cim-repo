...
public class NonConformLoadGroupQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          NonConformLoadGroupBusinessDelegate.getNonConformLoadGroupInstance()
              .getNonConformLoadGroup(
                  new NonConformLoadGroupFetchOneSummary(nonConformLoadGroupId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING, "failed to load NonConformLoadGroup using Id " + nonConformLoadGroupId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(NonConformLoadGroupQueryRestController.class.getName());
}
