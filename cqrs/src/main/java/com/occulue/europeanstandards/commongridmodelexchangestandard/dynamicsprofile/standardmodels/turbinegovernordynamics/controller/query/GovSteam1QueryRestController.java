...
public class GovSteam1QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          GovSteam1BusinessDelegate.getGovSteam1Instance()
              .getGovSteam1(new GovSteam1FetchOneSummary(govSteam1Id));
    } catch (Throwable exc) {
  ...
  public List<GovSteam1> loadAll() {
    ...
    try {
      ...
      if (govSteam1List != null) LOGGER.log(Level.INFO, "successfully loaded all GovSteam1s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(GovSteam1QueryRestController.class.getName());
}
