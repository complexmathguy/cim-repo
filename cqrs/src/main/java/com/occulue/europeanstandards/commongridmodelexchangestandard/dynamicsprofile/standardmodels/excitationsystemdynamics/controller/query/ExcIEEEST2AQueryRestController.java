...
public class ExcIEEEST2AQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEST2ABusinessDelegate.getExcIEEEST2AInstance()
              .getExcIEEEST2A(new ExcIEEEST2AFetchOneSummary(excIEEEST2AId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEST2A> loadAll() {
    ...
    try {
      ...
      if (excIEEEST2AList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEST2As");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEST2AQueryRestController.class.getName());
}
