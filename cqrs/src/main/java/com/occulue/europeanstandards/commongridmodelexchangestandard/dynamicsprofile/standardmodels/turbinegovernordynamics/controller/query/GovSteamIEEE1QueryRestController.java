...
public class GovSteamIEEE1QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          GovSteamIEEE1BusinessDelegate.getGovSteamIEEE1Instance()
              .getGovSteamIEEE1(new GovSteamIEEE1FetchOneSummary(govSteamIEEE1Id));
    } catch (Throwable exc) {
  ...
  public List<GovSteamIEEE1> loadAll() {
    ...
    try {
      ...
      govSteamIEEE1List =
          GovSteamIEEE1BusinessDelegate.getGovSteamIEEE1Instance().getAllGovSteamIEEE1();
  ...
  private static final Logger LOGGER =
      Logger.getLogger(GovSteamIEEE1QueryRestController.class.getName());
}
