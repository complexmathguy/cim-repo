...
public class UnderexcLimIEEE2QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          UnderexcLimIEEE2BusinessDelegate.getUnderexcLimIEEE2Instance()
              .getUnderexcLimIEEE2(new UnderexcLimIEEE2FetchOneSummary(underexcLimIEEE2Id));
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(UnderexcLimIEEE2QueryRestController.class.getName());
}
