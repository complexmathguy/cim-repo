...
public class VoltageAdjusterUserDefinedQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public VoltageAdjusterUserDefined load(
    ...
    try {
      entity =
          VoltageAdjusterUserDefinedBusinessDelegate.getVoltageAdjusterUserDefinedInstance()
              .getVoltageAdjusterUserDefined(
                  new VoltageAdjusterUserDefinedFetchOneSummary(voltageAdjusterUserDefinedId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load VoltageAdjusterUserDefined using Id " + voltageAdjusterUserDefinedId);
      return null;
    }
  ...
  public List<VoltageAdjusterUserDefined> loadAll() {
    ...
    try {
      ...
      voltageAdjusterUserDefinedList =
          VoltageAdjusterUserDefinedBusinessDelegate.getVoltageAdjusterUserDefinedInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(VoltageAdjusterUserDefinedQueryRestController.class.getName());
}
