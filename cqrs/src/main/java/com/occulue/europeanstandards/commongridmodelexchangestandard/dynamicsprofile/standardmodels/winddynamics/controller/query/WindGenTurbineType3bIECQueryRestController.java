...
public class WindGenTurbineType3bIECQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public WindGenTurbineType3bIEC load(
    ...
    try {
      entity =
          WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance()
              .getWindGenTurbineType3bIEC(
                  new WindGenTurbineType3bIECFetchOneSummary(windGenTurbineType3bIECId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load WindGenTurbineType3bIEC using Id " + windGenTurbineType3bIECId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindGenTurbineType3bIECQueryRestController.class.getName());
}
