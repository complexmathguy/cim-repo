...
public class EquivalentNetworkQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          EquivalentNetworkBusinessDelegate.getEquivalentNetworkInstance()
              .getEquivalentNetwork(new EquivalentNetworkFetchOneSummary(equivalentNetworkId));
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(EquivalentNetworkQueryRestController.class.getName());
}
