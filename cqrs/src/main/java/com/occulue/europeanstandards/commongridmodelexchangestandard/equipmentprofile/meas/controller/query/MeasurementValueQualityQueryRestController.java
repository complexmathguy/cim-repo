...
public class MeasurementValueQualityQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public MeasurementValueQuality load(
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING,
          "failed to load MeasurementValueQuality using Id " + measurementValueQualityId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(MeasurementValueQualityQueryRestController.class.getName());
}
