...
public class ExcIEEEDC4BQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEDC4BBusinessDelegate.getExcIEEEDC4BInstance()
              .getExcIEEEDC4B(new ExcIEEEDC4BFetchOneSummary(excIEEEDC4BId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEDC4B> loadAll() {
    ...
    try {
      ...
      if (excIEEEDC4BList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEDC4Bs");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEDC4BQueryRestController.class.getName());
}
