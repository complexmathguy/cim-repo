...
public class MechLoad1QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          MechLoad1BusinessDelegate.getMechLoad1Instance()
              .getMechLoad1(new MechLoad1FetchOneSummary(mechLoad1Id));
    } catch (Throwable exc) {
  ...
  public List<MechLoad1> loadAll() {
    ...
    try {
      ...
      if (mechLoad1List != null) LOGGER.log(Level.INFO, "successfully loaded all MechLoad1s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(MechLoad1QueryRestController.class.getName());
}
