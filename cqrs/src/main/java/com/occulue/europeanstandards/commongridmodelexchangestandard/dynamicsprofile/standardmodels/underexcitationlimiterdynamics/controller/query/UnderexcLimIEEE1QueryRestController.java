...
public class UnderexcLimIEEE1QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          UnderexcLimIEEE1BusinessDelegate.getUnderexcLimIEEE1Instance()
              .getUnderexcLimIEEE1(new UnderexcLimIEEE1FetchOneSummary(underexcLimIEEE1Id));
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(UnderexcLimIEEE1QueryRestController.class.getName());
}
