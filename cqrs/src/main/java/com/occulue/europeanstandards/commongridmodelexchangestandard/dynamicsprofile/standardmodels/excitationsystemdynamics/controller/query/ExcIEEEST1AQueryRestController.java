...
public class ExcIEEEST1AQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEST1ABusinessDelegate.getExcIEEEST1AInstance()
              .getExcIEEEST1A(new ExcIEEEST1AFetchOneSummary(excIEEEST1AId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEST1A> loadAll() {
    ...
    try {
      ...
      if (excIEEEST1AList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEST1As");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEST1AQueryRestController.class.getName());
}
