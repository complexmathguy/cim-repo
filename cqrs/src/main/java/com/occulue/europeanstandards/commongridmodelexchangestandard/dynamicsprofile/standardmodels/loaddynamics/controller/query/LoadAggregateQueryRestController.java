...
public class LoadAggregateQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          LoadAggregateBusinessDelegate.getLoadAggregateInstance()
              .getLoadAggregate(new LoadAggregateFetchOneSummary(loadAggregateId));
    } catch (Throwable exc) {
  ...
  public List<LoadAggregate> loadAll() {
    ...
    try {
      ...
      loadAggregateList =
          LoadAggregateBusinessDelegate.getLoadAggregateInstance().getAllLoadAggregate();
  ...
  private static final Logger LOGGER =
      Logger.getLogger(LoadAggregateQueryRestController.class.getName());
}
