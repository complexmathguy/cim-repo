...
public class ControlAreaGeneratingUnitQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public ControlAreaGeneratingUnit load(
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING,
          "failed to load ControlAreaGeneratingUnit using Id " + controlAreaGeneratingUnitId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ControlAreaGeneratingUnitQueryRestController.class.getName());
}
