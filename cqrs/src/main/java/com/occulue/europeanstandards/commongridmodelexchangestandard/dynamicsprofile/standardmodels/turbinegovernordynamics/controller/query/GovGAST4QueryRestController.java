...
public class GovGAST4QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          GovGAST4BusinessDelegate.getGovGAST4Instance()
              .getGovGAST4(new GovGAST4FetchOneSummary(govGAST4Id));
    } catch (Throwable exc) {
  ...
  public List<GovGAST4> loadAll() {
    ...
    try {
      ...
      if (govGAST4List != null) LOGGER.log(Level.INFO, "successfully loaded all GovGAST4s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(GovGAST4QueryRestController.class.getName());
}
