 ...
 * ****************************************************************************
 */
package com.occulue.europeanstandards.commongridmodelexchangestandard.statevariablesprofile.topology.controller.query;
...
public class TopologicalIslandQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          TopologicalIslandBusinessDelegate.getTopologicalIslandInstance()
              .getTopologicalIsland(new TopologicalIslandFetchOneSummary(topologicalIslandId));
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(TopologicalIslandQueryRestController.class.getName());
}
