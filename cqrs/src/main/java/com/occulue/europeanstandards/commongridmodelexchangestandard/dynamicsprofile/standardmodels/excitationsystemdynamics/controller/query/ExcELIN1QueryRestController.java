...
public class ExcELIN1QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcELIN1BusinessDelegate.getExcELIN1Instance()
              .getExcELIN1(new ExcELIN1FetchOneSummary(excELIN1Id));
    } catch (Throwable exc) {
  ...
  public List<ExcELIN1> loadAll() {
    ...
    try {
      ...
      if (excELIN1List != null) LOGGER.log(Level.INFO, "successfully loaded all ExcELIN1s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcELIN1QueryRestController.class.getName());
}
