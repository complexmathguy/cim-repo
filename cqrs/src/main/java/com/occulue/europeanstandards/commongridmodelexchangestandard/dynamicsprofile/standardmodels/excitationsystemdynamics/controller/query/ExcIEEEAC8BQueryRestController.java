...
public class ExcIEEEAC8BQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEAC8BBusinessDelegate.getExcIEEEAC8BInstance()
              .getExcIEEEAC8B(new ExcIEEEAC8BFetchOneSummary(excIEEEAC8BId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEAC8B> loadAll() {
    ...
    try {
      ...
      if (excIEEEAC8BList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEAC8Bs");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEAC8BQueryRestController.class.getName());
}
