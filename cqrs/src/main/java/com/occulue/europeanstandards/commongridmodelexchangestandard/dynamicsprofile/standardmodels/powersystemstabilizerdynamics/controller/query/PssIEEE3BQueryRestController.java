...
public class PssIEEE3BQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          PssIEEE3BBusinessDelegate.getPssIEEE3BInstance()
              .getPssIEEE3B(new PssIEEE3BFetchOneSummary(pssIEEE3BId));
    } catch (Throwable exc) {
  ...
  public List<PssIEEE3B> loadAll() {
    ...
    try {
      ...
      if (pssIEEE3BList != null) LOGGER.log(Level.INFO, "successfully loaded all PssIEEE3Bs");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PssIEEE3BQueryRestController.class.getName());
}
