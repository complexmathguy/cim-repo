 ...
 * ****************************************************************************
 */
package com.occulue.europeanstandards.commongridmodelexchangestandard.geographicallocationprofile.controller.query;
...
public class GeographicalLocationVersionQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public GeographicalLocationVersion load(
    ...
    try {
      entity =
          GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance()
              .getGeographicalLocationVersion(
                  new GeographicalLocationVersionFetchOneSummary(geographicalLocationVersionId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load GeographicalLocationVersion using Id " + geographicalLocationVersionId);
      return null;
    }
  ...
  public List<GeographicalLocationVersion> loadAll() {
    ...
    try {
      ...
      geographicalLocationVersionList =
          GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(GeographicalLocationVersionQueryRestController.class.getName());
}
