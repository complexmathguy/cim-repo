...
public class WindContPType3IECQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          WindContPType3IECBusinessDelegate.getWindContPType3IECInstance()
              .getWindContPType3IEC(new WindContPType3IECFetchOneSummary(windContPType3IECId));
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindContPType3IECQueryRestController.class.getName());
}
