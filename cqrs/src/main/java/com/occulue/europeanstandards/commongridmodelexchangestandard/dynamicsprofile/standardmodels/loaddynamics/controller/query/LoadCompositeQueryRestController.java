...
public class LoadCompositeQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          LoadCompositeBusinessDelegate.getLoadCompositeInstance()
              .getLoadComposite(new LoadCompositeFetchOneSummary(loadCompositeId));
    } catch (Throwable exc) {
  ...
  public List<LoadComposite> loadAll() {
    ...
    try {
      ...
      loadCompositeList =
          LoadCompositeBusinessDelegate.getLoadCompositeInstance().getAllLoadComposite();
  ...
  private static final Logger LOGGER =
      Logger.getLogger(LoadCompositeQueryRestController.class.getName());
}
