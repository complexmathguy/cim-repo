...
public class WindAeroConstIECQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          WindAeroConstIECBusinessDelegate.getWindAeroConstIECInstance()
              .getWindAeroConstIEC(new WindAeroConstIECFetchOneSummary(windAeroConstIECId));
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindAeroConstIECQueryRestController.class.getName());
}
