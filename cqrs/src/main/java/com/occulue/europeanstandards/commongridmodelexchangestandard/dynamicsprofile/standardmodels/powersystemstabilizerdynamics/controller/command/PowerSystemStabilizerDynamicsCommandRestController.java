...
public class PowerSystemStabilizerDynamicsCommandRestController extends BaseSpringRestController {
  ...
  /**
   * Handles create a PowerSystemStabilizerDynamics. if not key provided, calls create, otherwise
   * calls save
   *
  ...
  public CompletableFuture<UUID> create(
      @RequestBody(required = true) CreatePowerSystemStabilizerDynamicsCommand command) {
    CompletableFuture<UUID> completableFuture = null;
    try {

      completableFuture =
          PowerSystemStabilizerDynamicsBusinessDelegate.getPowerSystemStabilizerDynamicsInstance()
              .createPowerSystemStabilizerDynamics(command);
    } catch (Throwable exc) {
  ...
  /**
   * Handles updating a PowerSystemStabilizerDynamics. if no key provided, calls create, otherwise
   * calls save
   *
   * @param PowerSystemStabilizerDynamics powerSystemStabilizerDynamics
  ...
  public CompletableFuture<Void> update(
      @RequestBody(required = true) UpdatePowerSystemStabilizerDynamicsCommand command) {
    ...
    try {
      ...
      completableFuture =
          PowerSystemStabilizerDynamicsBusinessDelegate.getPowerSystemStabilizerDynamicsInstance()
              .updatePowerSystemStabilizerDynamics(command);
      ;
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "PowerSystemStabilizerDynamicsController:update() - successfully update PowerSystemStabilizerDynamics - "
              + exc.getMessage());
    }
  ...
  public CompletableFuture<Void> delete(
    ...
    CompletableFuture<Void> completableFuture = null;
    DeletePowerSystemStabilizerDynamicsCommand command =
        new DeletePowerSystemStabilizerDynamicsCommand(powerSystemStabilizerDynamicsId);

    try {
      PowerSystemStabilizerDynamicsBusinessDelegate delegate =
          PowerSystemStabilizerDynamicsBusinessDelegate.getPowerSystemStabilizerDynamicsInstance();

      completableFuture = delegate.delete(command);
      LOGGER.log(
          Level.WARNING,
          "Successfully deleted PowerSystemStabilizerDynamics with key "
  ...
  /**
   * save PowerSystemStabilizerDynamics on PowerSystemStabilizerDynamics
   *
  ...
  public void assignPowerSystemStabilizerDynamics(
    ...
    try {
      PowerSystemStabilizerDynamicsBusinessDelegate.getPowerSystemStabilizerDynamicsInstance()
          .assignPowerSystemStabilizerDynamics(command);
    } catch (Throwable exc) {
  ...
  public void unAssignPowerSystemStabilizerDynamics(
    ...
    try {
      PowerSystemStabilizerDynamicsBusinessDelegate.getPowerSystemStabilizerDynamicsInstance()
          .unAssignPowerSystemStabilizerDynamics(command);
    } catch (Exception exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PowerSystemStabilizerDynamicsCommandRestController.class.getName());
}
