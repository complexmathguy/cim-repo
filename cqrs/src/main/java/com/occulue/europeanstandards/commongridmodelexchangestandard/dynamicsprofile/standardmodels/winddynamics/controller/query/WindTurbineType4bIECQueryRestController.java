...
public class WindTurbineType4bIECQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          WindTurbineType4bIECBusinessDelegate.getWindTurbineType4bIECInstance()
              .getWindTurbineType4bIEC(
                  new WindTurbineType4bIECFetchOneSummary(windTurbineType4bIECId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING, "failed to load WindTurbineType4bIEC using Id " + windTurbineType4bIECId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindTurbineType4bIECQueryRestController.class.getName());
}
