...
public class ProprietaryParameterDynamicsQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public ProprietaryParameterDynamics load(
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING,
          "failed to load ProprietaryParameterDynamics using Id " + proprietaryParameterDynamicsId);
      return null;
    }
  ...
  public List<ProprietaryParameterDynamics> loadAll() {
    ...
    try {
      ...
      proprietaryParameterDynamicsList =
          ProprietaryParameterDynamicsBusinessDelegate.getProprietaryParameterDynamicsInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ProprietaryParameterDynamicsQueryRestController.class.getName());
}
