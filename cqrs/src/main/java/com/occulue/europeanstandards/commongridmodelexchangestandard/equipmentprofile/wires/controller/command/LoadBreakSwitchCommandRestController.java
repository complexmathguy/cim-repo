...
public class LoadBreakSwitchCommandRestController extends BaseSpringRestController {
  ...
  public CompletableFuture<UUID> create(
      @RequestBody(required = true) CreateLoadBreakSwitchCommand command) {
    CompletableFuture<UUID> completableFuture = null;
    try {

      completableFuture =
          LoadBreakSwitchBusinessDelegate.getLoadBreakSwitchInstance()
              .createLoadBreakSwitch(command);
    } catch (Throwable exc) {
  ...
  public CompletableFuture<Void> update(
      @RequestBody(required = true) UpdateLoadBreakSwitchCommand command) {
    ...
    try {
      ...
      completableFuture =
          LoadBreakSwitchBusinessDelegate.getLoadBreakSwitchInstance()
              .updateLoadBreakSwitch(command);
      ;
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "LoadBreakSwitchController:update() - successfully update LoadBreakSwitch - "
              + exc.getMessage());
    }
  ...
  public CompletableFuture<Void> delete(@RequestParam(required = true) UUID loadBreakSwitchId) {
    ...
    try {
      LoadBreakSwitchBusinessDelegate delegate =
          LoadBreakSwitchBusinessDelegate.getLoadBreakSwitchInstance();

      completableFuture = delegate.delete(command);
      LOGGER.log(
          Level.WARNING,
          "Successfully deleted LoadBreakSwitch with key " + command.getLoadBreakSwitchId());
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(LoadBreakSwitchCommandRestController.class.getName());
}
