...
public class DiscExcContIEEEDEC2AQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          DiscExcContIEEEDEC2ABusinessDelegate.getDiscExcContIEEEDEC2AInstance()
              .getDiscExcContIEEEDEC2A(
                  new DiscExcContIEEEDEC2AFetchOneSummary(discExcContIEEEDEC2AId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING, "failed to load DiscExcContIEEEDEC2A using Id " + discExcContIEEEDEC2AId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(DiscExcContIEEEDEC2AQueryRestController.class.getName());
}
