...
public class WindTurbineType3or4DynamicsQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public WindTurbineType3or4Dynamics load(
    ...
    try {
      entity =
          WindTurbineType3or4DynamicsBusinessDelegate.getWindTurbineType3or4DynamicsInstance()
              .getWindTurbineType3or4Dynamics(
                  new WindTurbineType3or4DynamicsFetchOneSummary(windTurbineType3or4DynamicsId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load WindTurbineType3or4Dynamics using Id " + windTurbineType3or4DynamicsId);
      return null;
    }
  ...
  public List<WindTurbineType3or4Dynamics> loadAll() {
    ...
    try {
      ...
      windTurbineType3or4DynamicsList =
          WindTurbineType3or4DynamicsBusinessDelegate.getWindTurbineType3or4DynamicsInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindTurbineType3or4DynamicsQueryRestController.class.getName());
}
