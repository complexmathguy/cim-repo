...
public class PowerSystemResourceQueryRestController extends BaseSpringRestController {
  ...
  public PowerSystemResource load(@RequestParam(required = true) UUID powerSystemResourceId) {
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING, "failed to load PowerSystemResource using Id " + powerSystemResourceId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PowerSystemResourceQueryRestController.class.getName());
}
