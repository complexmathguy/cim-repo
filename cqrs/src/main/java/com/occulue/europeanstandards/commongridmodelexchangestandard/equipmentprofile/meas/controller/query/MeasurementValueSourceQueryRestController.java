...
public class MeasurementValueSourceQueryRestController extends BaseSpringRestController {
  ...
  public MeasurementValueSource load(@RequestParam(required = true) UUID measurementValueSourceId) {
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING,
          "failed to load MeasurementValueSource using Id " + measurementValueSourceId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(MeasurementValueSourceQueryRestController.class.getName());
}
