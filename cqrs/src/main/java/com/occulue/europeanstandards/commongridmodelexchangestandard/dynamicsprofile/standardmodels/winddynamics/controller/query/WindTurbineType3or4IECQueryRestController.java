...
public class WindTurbineType3or4IECQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          WindTurbineType3or4IECBusinessDelegate.getWindTurbineType3or4IECInstance()
              .getWindTurbineType3or4IEC(
                  new WindTurbineType3or4IECFetchOneSummary(windTurbineType3or4IECId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load WindTurbineType3or4IEC using Id " + windTurbineType3or4IECId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindTurbineType3or4IECQueryRestController.class.getName());
}
