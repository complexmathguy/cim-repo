...
public class ExcIEEEAC7BQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEAC7BBusinessDelegate.getExcIEEEAC7BInstance()
              .getExcIEEEAC7B(new ExcIEEEAC7BFetchOneSummary(excIEEEAC7BId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEAC7B> loadAll() {
    ...
    try {
      ...
      if (excIEEEAC7BList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEAC7Bs");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEAC7BQueryRestController.class.getName());
}
