...
public class GovHydroIEEE2QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          GovHydroIEEE2BusinessDelegate.getGovHydroIEEE2Instance()
              .getGovHydroIEEE2(new GovHydroIEEE2FetchOneSummary(govHydroIEEE2Id));
    } catch (Throwable exc) {
  ...
  public List<GovHydroIEEE2> loadAll() {
    ...
    try {
      ...
      govHydroIEEE2List =
          GovHydroIEEE2BusinessDelegate.getGovHydroIEEE2Instance().getAllGovHydroIEEE2();
  ...
  private static final Logger LOGGER =
      Logger.getLogger(GovHydroIEEE2QueryRestController.class.getName());
}
