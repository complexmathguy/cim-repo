...
public class GovGAST1QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          GovGAST1BusinessDelegate.getGovGAST1Instance()
              .getGovGAST1(new GovGAST1FetchOneSummary(govGAST1Id));
    } catch (Throwable exc) {
  ...
  public List<GovGAST1> loadAll() {
    ...
    try {
      ...
      if (govGAST1List != null) LOGGER.log(Level.INFO, "successfully loaded all GovGAST1s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(GovGAST1QueryRestController.class.getName());
}
