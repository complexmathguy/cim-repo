...
public class ExcIEEEST6BQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEST6BBusinessDelegate.getExcIEEEST6BInstance()
              .getExcIEEEST6B(new ExcIEEEST6BFetchOneSummary(excIEEEST6BId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEST6B> loadAll() {
    ...
    try {
      ...
      if (excIEEEST6BList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEST6Bs");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEST6BQueryRestController.class.getName());
}
