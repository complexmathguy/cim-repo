...
public class PssIEEE2BQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          PssIEEE2BBusinessDelegate.getPssIEEE2BInstance()
              .getPssIEEE2B(new PssIEEE2BFetchOneSummary(pssIEEE2BId));
    } catch (Throwable exc) {
  ...
  public List<PssIEEE2B> loadAll() {
    ...
    try {
      ...
      if (pssIEEE2BList != null) LOGGER.log(Level.INFO, "successfully loaded all PssIEEE2Bs");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PssIEEE2BQueryRestController.class.getName());
}
