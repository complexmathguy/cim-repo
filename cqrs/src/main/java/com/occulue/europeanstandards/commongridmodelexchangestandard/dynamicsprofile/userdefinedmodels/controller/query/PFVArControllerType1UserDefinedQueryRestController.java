...
public class PFVArControllerType1UserDefinedQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public PFVArControllerType1UserDefined load(
      ...
      entity =
          PFVArControllerType1UserDefinedBusinessDelegate
              ...
              .getPFVArControllerType1UserDefined(
                  new PFVArControllerType1UserDefinedFetchOneSummary(
                      pFVArControllerType1UserDefinedId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load PFVArControllerType1UserDefined using Id "
              + pFVArControllerType1UserDefinedId);
      return null;
    }
  ...
  public List<PFVArControllerType1UserDefined> loadAll() {
    ...
    try {
      ...
      pFVArControllerType1UserDefinedList =
          PFVArControllerType1UserDefinedBusinessDelegate
              .getPFVArControllerType1UserDefinedInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PFVArControllerType1UserDefinedQueryRestController.class.getName());
}
