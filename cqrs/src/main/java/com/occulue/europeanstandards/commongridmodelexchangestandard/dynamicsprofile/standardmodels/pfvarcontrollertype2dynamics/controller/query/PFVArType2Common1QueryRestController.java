...
public class PFVArType2Common1QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          PFVArType2Common1BusinessDelegate.getPFVArType2Common1Instance()
              .getPFVArType2Common1(new PFVArType2Common1FetchOneSummary(pFVArType2Common1Id));
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PFVArType2Common1QueryRestController.class.getName());
}
