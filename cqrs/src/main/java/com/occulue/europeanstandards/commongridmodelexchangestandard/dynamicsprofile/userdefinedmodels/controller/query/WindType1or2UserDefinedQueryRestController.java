...
public class WindType1or2UserDefinedQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public WindType1or2UserDefined load(
    ...
    try {
      entity =
          WindType1or2UserDefinedBusinessDelegate.getWindType1or2UserDefinedInstance()
              .getWindType1or2UserDefined(
                  new WindType1or2UserDefinedFetchOneSummary(windType1or2UserDefinedId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load WindType1or2UserDefined using Id " + windType1or2UserDefinedId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindType1or2UserDefinedQueryRestController.class.getName());
}
