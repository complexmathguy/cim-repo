...
public class ConnectivityNodeContainerQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public ConnectivityNodeContainer load(
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING,
          "failed to load ConnectivityNodeContainer using Id " + connectivityNodeContainerId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ConnectivityNodeContainerQueryRestController.class.getName());
}
