 ...
 * ****************************************************************************
 */
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.loaddynamics.controller.query;
...
public class LoadDynamicsQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          LoadDynamicsBusinessDelegate.getLoadDynamicsInstance()
              .getLoadDynamics(new LoadDynamicsFetchOneSummary(loadDynamicsId));
    } catch (Throwable exc) {
  ...
  public List<LoadDynamics> loadAll() {
    ...
    try {
      ...
      loadDynamicsList =
          LoadDynamicsBusinessDelegate.getLoadDynamicsInstance().getAllLoadDynamics();

      if (loadDynamicsList != null) LOGGER.log(Level.INFO, "successfully loaded all LoadDynamicss");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(LoadDynamicsQueryRestController.class.getName());
}
