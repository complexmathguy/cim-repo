...
public class PssSB4QueryRestController extends BaseSpringRestController {
  ...
  public PssSB4 load(@RequestParam(required = true) UUID pssSB4Id) {
    ...
    try {
      entity =
          PssSB4BusinessDelegate.getPssSB4Instance().getPssSB4(new PssSB4FetchOneSummary(pssSB4Id));
    } catch (Throwable exc) {
  ...
  public List<PssSB4> loadAll() {
    ...
    try {
      ...
      if (pssSB4List != null) LOGGER.log(Level.INFO, "successfully loaded all PssSB4s");
    } catch (Throwable exc) {
