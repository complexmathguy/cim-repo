...
public class AsynchronousMachineDynamicsQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public AsynchronousMachineDynamics load(
    ...
    try {
      entity =
          AsynchronousMachineDynamicsBusinessDelegate.getAsynchronousMachineDynamicsInstance()
              .getAsynchronousMachineDynamics(
                  new AsynchronousMachineDynamicsFetchOneSummary(asynchronousMachineDynamicsId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load AsynchronousMachineDynamics using Id " + asynchronousMachineDynamicsId);
      return null;
    }
  ...
  public List<AsynchronousMachineDynamics> loadAll() {
    ...
    try {
      ...
      asynchronousMachineDynamicsList =
          AsynchronousMachineDynamicsBusinessDelegate.getAsynchronousMachineDynamicsInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(AsynchronousMachineDynamicsQueryRestController.class.getName());
}
