...
public class SeasonDayTypeScheduleQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          SeasonDayTypeScheduleBusinessDelegate.getSeasonDayTypeScheduleInstance()
              .getSeasonDayTypeSchedule(
                  new SeasonDayTypeScheduleFetchOneSummary(seasonDayTypeScheduleId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load SeasonDayTypeSchedule using Id " + seasonDayTypeScheduleId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(SeasonDayTypeScheduleQueryRestController.class.getName());
}
