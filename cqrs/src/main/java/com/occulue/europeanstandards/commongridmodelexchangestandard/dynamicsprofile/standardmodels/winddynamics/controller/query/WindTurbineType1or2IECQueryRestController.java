...
public class WindTurbineType1or2IECQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          WindTurbineType1or2IECBusinessDelegate.getWindTurbineType1or2IECInstance()
              .getWindTurbineType1or2IEC(
                  new WindTurbineType1or2IECFetchOneSummary(windTurbineType1or2IECId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load WindTurbineType1or2IEC using Id " + windTurbineType1or2IECId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindTurbineType1or2IECQueryRestController.class.getName());
}
