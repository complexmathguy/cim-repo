...
public class OverexcLimX1QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          OverexcLimX1BusinessDelegate.getOverexcLimX1Instance()
              .getOverexcLimX1(new OverexcLimX1FetchOneSummary(overexcLimX1Id));
    } catch (Throwable exc) {
  ...
  public List<OverexcLimX1> loadAll() {
    ...
    try {
      ...
      overexcLimX1List =
          OverexcLimX1BusinessDelegate.getOverexcLimX1Instance().getAllOverexcLimX1();

      if (overexcLimX1List != null) LOGGER.log(Level.INFO, "successfully loaded all OverexcLimX1s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(OverexcLimX1QueryRestController.class.getName());
}
