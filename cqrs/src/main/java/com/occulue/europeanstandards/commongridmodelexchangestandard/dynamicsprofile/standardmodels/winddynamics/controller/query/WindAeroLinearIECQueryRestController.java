...
public class WindAeroLinearIECQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          WindAeroLinearIECBusinessDelegate.getWindAeroLinearIECInstance()
              .getWindAeroLinearIEC(new WindAeroLinearIECFetchOneSummary(windAeroLinearIECId));
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindAeroLinearIECQueryRestController.class.getName());
}
