...
public class ExcIEEEAC5AQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcIEEEAC5ABusinessDelegate.getExcIEEEAC5AInstance()
              .getExcIEEEAC5A(new ExcIEEEAC5AFetchOneSummary(excIEEEAC5AId));
    } catch (Throwable exc) {
  ...
  public List<ExcIEEEAC5A> loadAll() {
    ...
    try {
      ...
      if (excIEEEAC5AList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcIEEEAC5As");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcIEEEAC5AQueryRestController.class.getName());
}
