...
public class SynchronousMachineUserDefinedQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public SynchronousMachineUserDefined load(
      ...
      entity =
          SynchronousMachineUserDefinedBusinessDelegate.getSynchronousMachineUserDefinedInstance()
              .getSynchronousMachineUserDefined(
                  new SynchronousMachineUserDefinedFetchOneSummary(
                      synchronousMachineUserDefinedId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load SynchronousMachineUserDefined using Id "
              + synchronousMachineUserDefinedId);
      return null;
    }
  ...
  public List<SynchronousMachineUserDefined> loadAll() {
    ...
    try {
      ...
      synchronousMachineUserDefinedList =
          SynchronousMachineUserDefinedBusinessDelegate.getSynchronousMachineUserDefinedInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(SynchronousMachineUserDefinedQueryRestController.class.getName());
}
