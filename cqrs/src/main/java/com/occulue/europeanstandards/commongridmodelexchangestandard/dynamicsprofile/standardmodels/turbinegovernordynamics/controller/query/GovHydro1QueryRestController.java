...
public class GovHydro1QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          GovHydro1BusinessDelegate.getGovHydro1Instance()
              .getGovHydro1(new GovHydro1FetchOneSummary(govHydro1Id));
    } catch (Throwable exc) {
  ...
  public List<GovHydro1> loadAll() {
    ...
    try {
      ...
      if (govHydro1List != null) LOGGER.log(Level.INFO, "successfully loaded all GovHydro1s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(GovHydro1QueryRestController.class.getName());
}
