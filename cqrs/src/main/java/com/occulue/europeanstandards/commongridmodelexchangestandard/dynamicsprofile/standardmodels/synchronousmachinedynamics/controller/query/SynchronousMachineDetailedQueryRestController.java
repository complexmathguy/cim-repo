...
public class SynchronousMachineDetailedQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public SynchronousMachineDetailed load(
    ...
    try {
      entity =
          SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance()
              .getSynchronousMachineDetailed(
                  new SynchronousMachineDetailedFetchOneSummary(synchronousMachineDetailedId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load SynchronousMachineDetailed using Id " + synchronousMachineDetailedId);
      return null;
    }
  ...
  public List<SynchronousMachineDetailed> loadAll() {
    ...
    try {
      ...
      synchronousMachineDetailedList =
          SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(SynchronousMachineDetailedQueryRestController.class.getName());
}
