...
public class PFVArType2IEEEPFControllerQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public PFVArType2IEEEPFController load(
    ...
    try {
      entity =
          PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance()
              .getPFVArType2IEEEPFController(
                  new PFVArType2IEEEPFControllerFetchOneSummary(pFVArType2IEEEPFControllerId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load PFVArType2IEEEPFController using Id " + pFVArType2IEEEPFControllerId);
      return null;
    }
  ...
  public List<PFVArType2IEEEPFController> loadAll() {
    ...
    try {
      ...
      pFVArType2IEEEPFControllerList =
          PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PFVArType2IEEEPFControllerQueryRestController.class.getName());
}
