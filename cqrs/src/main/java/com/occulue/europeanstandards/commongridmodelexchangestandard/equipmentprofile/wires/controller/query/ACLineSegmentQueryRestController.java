...
public class ACLineSegmentQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ACLineSegmentBusinessDelegate.getACLineSegmentInstance()
              .getACLineSegment(new ACLineSegmentFetchOneSummary(aCLineSegmentId));
    } catch (Throwable exc) {
  ...
  public List<ACLineSegment> loadAll() {
    ...
    try {
      ...
      aCLineSegmentList =
          ACLineSegmentBusinessDelegate.getACLineSegmentInstance().getAllACLineSegment();
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ACLineSegmentQueryRestController.class.getName());
}
