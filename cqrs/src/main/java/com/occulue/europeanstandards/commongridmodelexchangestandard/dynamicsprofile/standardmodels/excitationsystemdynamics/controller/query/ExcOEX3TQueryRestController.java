...
public class ExcOEX3TQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          ExcOEX3TBusinessDelegate.getExcOEX3TInstance()
              .getExcOEX3T(new ExcOEX3TFetchOneSummary(excOEX3TId));
    } catch (Throwable exc) {
  ...
  public List<ExcOEX3T> loadAll() {
    ...
    try {
      ...
      if (excOEX3TList != null) LOGGER.log(Level.INFO, "successfully loaded all ExcOEX3Ts");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcOEX3TQueryRestController.class.getName());
}
