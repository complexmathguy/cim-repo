...
public class PhaseTapChangerAsymmetricalQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public PhaseTapChangerAsymmetrical load(
    ...
    try {
      entity =
          PhaseTapChangerAsymmetricalBusinessDelegate.getPhaseTapChangerAsymmetricalInstance()
              .getPhaseTapChangerAsymmetrical(
                  new PhaseTapChangerAsymmetricalFetchOneSummary(phaseTapChangerAsymmetricalId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load PhaseTapChangerAsymmetrical using Id " + phaseTapChangerAsymmetricalId);
      return null;
    }
  ...
  public List<PhaseTapChangerAsymmetrical> loadAll() {
    ...
    try {
      ...
      phaseTapChangerAsymmetricalList =
          PhaseTapChangerAsymmetricalBusinessDelegate.getPhaseTapChangerAsymmetricalInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PhaseTapChangerAsymmetricalQueryRestController.class.getName());
}
