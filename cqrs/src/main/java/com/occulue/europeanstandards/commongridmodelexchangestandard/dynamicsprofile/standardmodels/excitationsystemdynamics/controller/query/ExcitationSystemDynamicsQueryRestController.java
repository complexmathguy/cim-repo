...
public class ExcitationSystemDynamicsQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public ExcitationSystemDynamics load(
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING,
          "failed to load ExcitationSystemDynamics using Id " + excitationSystemDynamicsId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcitationSystemDynamicsQueryRestController.class.getName());
}
