 ...
 * ****************************************************************************
 */
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.pfvarcontrollertype2dynamics.controller.query;
...
public class PFVArControllerType2DynamicsQueryRestController extends BaseSpringRestController {
   ...
   */
  @GetMapping("/load")
  public PFVArControllerType2Dynamics load(
    ...
    try {
      entity =
          PFVArControllerType2DynamicsBusinessDelegate.getPFVArControllerType2DynamicsInstance()
              .getPFVArControllerType2Dynamics(
                  new PFVArControllerType2DynamicsFetchOneSummary(pFVArControllerType2DynamicsId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING,
          "failed to load PFVArControllerType2Dynamics using Id " + pFVArControllerType2DynamicsId);
      return null;
    }
  ...
  public List<PFVArControllerType2Dynamics> loadAll() {
    ...
    try {
      ...
      pFVArControllerType2DynamicsList =
          PFVArControllerType2DynamicsBusinessDelegate.getPFVArControllerType2DynamicsInstance()
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PFVArControllerType2DynamicsQueryRestController.class.getName());
}
