...
public class GovHydro2QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          GovHydro2BusinessDelegate.getGovHydro2Instance()
              .getGovHydro2(new GovHydro2FetchOneSummary(govHydro2Id));
    } catch (Throwable exc) {
  ...
  public List<GovHydro2> loadAll() {
    ...
    try {
      ...
      if (govHydro2List != null) LOGGER.log(Level.INFO, "successfully loaded all GovHydro2s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(GovHydro2QueryRestController.class.getName());
}
