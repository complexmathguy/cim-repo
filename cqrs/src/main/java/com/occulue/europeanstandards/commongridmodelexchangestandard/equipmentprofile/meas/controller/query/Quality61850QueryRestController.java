...
public class Quality61850QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          Quality61850BusinessDelegate.getQuality61850Instance()
              .getQuality61850(new Quality61850FetchOneSummary(quality61850Id));
    } catch (Throwable exc) {
  ...
  public List<Quality61850> loadAll() {
    ...
    try {
      ...
      quality61850List =
          Quality61850BusinessDelegate.getQuality61850Instance().getAllQuality61850();

      if (quality61850List != null) LOGGER.log(Level.INFO, "successfully loaded all Quality61850s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(Quality61850QueryRestController.class.getName());
}
