...
public class TurbLCFB1QueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          TurbLCFB1BusinessDelegate.getTurbLCFB1Instance()
              .getTurbLCFB1(new TurbLCFB1FetchOneSummary(turbLCFB1Id));
    } catch (Throwable exc) {
  ...
  public List<TurbLCFB1> loadAll() {
    ...
    try {
      ...
      if (turbLCFB1List != null) LOGGER.log(Level.INFO, "successfully loaded all TurbLCFB1s");
    } catch (Throwable exc) {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(TurbLCFB1QueryRestController.class.getName());
}
