...
public class WindTurbineType4aIECQueryRestController extends BaseSpringRestController {
    ...
    try {
      entity =
          WindTurbineType4aIECBusinessDelegate.getWindTurbineType4aIECInstance()
              .getWindTurbineType4aIEC(
                  new WindTurbineType4aIECFetchOneSummary(windTurbineType4aIECId));
    } catch (Throwable exc) {
      LOGGER.log(
          Level.WARNING, "failed to load WindTurbineType4aIEC using Id " + windTurbineType4aIECId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindTurbineType4aIECQueryRestController.class.getName());
}
