...
public class ThermalGeneratingUnitQueryRestController extends BaseSpringRestController {
  ...
  public ThermalGeneratingUnit load(@RequestParam(required = true) UUID thermalGeneratingUnitId) {
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING,
          "failed to load ThermalGeneratingUnit using Id " + thermalGeneratingUnitId);
      return null;
    }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ThermalGeneratingUnitQueryRestController.class.getName());
}
