...
echo 'add a remote pseudo for the cim-repo repository'

git remote add origin https://complexmathguy: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@github.com/complexmathguy/cim-repo
